...
description: "사업자 폐업 후 남은 재고·설비 매각의 부가세 과세 여부, 세금계산서·영수증 발급, 신고 시기와 준비서류, 국세청 확인 경로를 정리한 실무 기준"
...
image:
  ...
  alt: "폐업 후 자산처분 썸네일"
---
폐업 전후의 매각일, 세금계산서 발급 여부, 부가가치세 신고 기한을 나눠 보면 준비해야 할 서류와 신고 시점을 잡기 쉽습니다.
...
실제 사례에서는 재고는 비교적 단순히 매출로 처리되는 반면 설비는 장부가·감가상각 영향 때문에 회계·세무 처리가 복잡해지는 경우가 많습니다. **매각가를 어떻게 산정했는지(시가, 장부가, 감정가 등)**를 기록해 두면 나중에 세무조사나 정산 시 유리합니다.
...
따라서 위 안내를 기본으로 삼되 최신 규정은 국세청(홈택스) 공지나 관할 세무서에서 확인하세요.
