...
오늘의 확인한 바로는, 전대 금지 조항이 계약서에 있어도 '실무상' 전월세 신고나 확정일자를 받는 절차 자체는 가능한 경우가 많습니다. 다만, 전대가 금지된 상태에서 전대를 하면 원계약(임대인↔임차인) 관계에 위반이 발생할 수 있고, 그에 따른 법적 위험(계약해지·명도 요구 등)이나 우선순위 문제는 남을 수 있으니 가능한 한 임대인 동의를 받는 게 안전합니다. 본문에서 상황별로 어떤 절차를 밟아야 하는지, 어떤 점을 확인해야 하는지 처음 확인하는 사람도 따라갈 수 있게 정리했습니다.
...
3) 실무적으로 가능한 절차(확인한 바로는 다음과 같은 선택지가 있습니다)
- 옵션 A — 임대인 동의 받기(권장)
...
- 옵션 B — 임대인 동의 없이 전대(위험 있음)
  ...
  2. 다만 확인한 바로는 일부 행정기관이나 시스템에서는 신고·확정일자 발급 자체를 거부하지는 않더라도, 법적 분쟁이 발생하면 전대의 무단성 때문에 권리 보호에 제약이 생길 수 있습니다.
  권장하지 않음: 가능하면 피하고, 불가피하면 법률 상담 권장.

4) 전월세 신고는 누가, 어디에, 언제 하는가?
- 신고 주체: 법령·지자체 규정에 따라 임대인 또는 임차인 중 어느 쪽이 신고해야 하는지가 달라질 수 있습니다. 확인한 바로는 중앙정부에서 통합안이 있지만, 지자체별 행정처리 방식이 남아 있습니다.
...
8) 공식 확인은 어디에서?
확인한 바로는, 아래 기관에서 최신 정보를 확인하는 것이 좋습니다.
...
따라서 본 문서의 내용은 확인 기준일(2026-07-16) 기준으로 정리한 것이며, 이후에는 관련 기관의 최신 공지·법령·판례를 확인하는 편이 안전합니다.
